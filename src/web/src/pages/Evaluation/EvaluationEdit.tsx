      ...
      <header className="flex-shrink-0 bg-white border-b border-[#E5E7EB] px-4 py-3">
        <div className="mx-auto h-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-[#111827]">编辑评测</h1>
              <p className="text-xs text-[#9CA3AF]">修改评测内容</p>
            </div>
          </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className="w-10 h-10 rounded-lg border border-[#E5E7EB]"
                        ...
                        <input
                          ...
                          placeholder="#6366F1"
                          className="flex-1 border border-[#E5E7EB] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#4F46E5] focus:border-transparent"
                        />
                      </div>
                    </div>
                  </div>
                    ...
                    {DEFAULT_DIMENSIONS.map(dim => (
                      <div key={dim.key} className="bg-[#F9FAFB] rounded-lg p-3 border border-[#E5E7EB]">
                        ...
                        <input
                          ...
                          min="0"
                          max="100"
                          className="w-full border border-[#E5E7EB] rounded-md px-2.5 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#4F46E5] focus:border-transparent bg-white"
                        />
                      </div>
                    ))}
                  </div>
