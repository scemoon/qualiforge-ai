...
export default function AdminArticleReview() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-[#111827] mb-6">文章审核</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg border border-[#E5E7EB] overflow-hidden">
          ...
          {articles.length === 0 ? (
            <div className="p-8 text-center text-[#9CA3AF] text-sm">暂无待审核文章 ✅</div>
          ) : (
        ...
        <div className="lg:col-span-2 bg-white rounded-lg border border-[#E5E7EB] p-6">
          {!selectedId ? (
            <div className="text-center py-16 text-[#9CA3AF]">← 请选择左侧文章进行审核</div>
          ) : loadingArticle ? (
            ...
            <div>
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h2 className="text-xl font-bold text-[#111827]">{articleData?.data?.title}</h2>
              ...
              <div className="prose max-w-none text-sm text-[#4B5563] mb-6 max-h-64 overflow-y-auto">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-[#E5E7EB]">
                ...
                <div className="flex-1 flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-1.5 bg-[#EF4444] text-white rounded-md text-sm hover:bg-[#DC2626] transition disabled:opacity-50"
                  >
                    驳回
                  </button>
                </div>
