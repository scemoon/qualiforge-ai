...
async function fetchEvaluations({ page = 1, skillId }: { page?: number; skillId?: string }) {
  const res = await fetch('https://cloud1-2gavd8kj8a1ce021.service.tcloudbase.com/api/forge/evaluation-crud', {
...
async function fetchSkills() {
  const res = await fetch('https://cloud1-2gavd8kj8a1ce021.service.tcloudbase.com/api/forge/skill-crud', {
    method: 'POST', headers: { 'Content-Type': 'application/json' },
