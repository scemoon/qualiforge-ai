 ...
 * @param valueType
 */
export declare const treeStoreExpendEffect: (treeStore: CascaderContextType["treeStore"], value: CascaderContextType["value"], expend: TreeNodeValue[], valueType?: TdCascaderProps["valueType"]) => void;
