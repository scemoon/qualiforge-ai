import type { CascaderContextType, CascaderValue, TdCascaderProps, TreeNode, TreeNodeValue } from '../interface';
/**
 * 单选状态下内容
 * @param isHover
 ...
 * 获取用于展开的节点值
 */
export declare const getExpandValue: (value: CascaderContextType["value"], valueType?: TdCascaderProps["valueType"]) => TreeNodeValue;
/**
 * 空值校验
