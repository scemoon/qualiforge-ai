...
import { _ as _toConsumableArray } from './dep-1e9f924f.js';
import { _ as _objectWithoutProperties } from './dep-4461a684.js';
import { _ as _slicedToArray } from './dep-94a7af64.js';
import { _ as _defineProperty } from './dep-5e72c8b9.js';
...
function isChromium() {
  var _window$navigator$use, _window2;
  if (typeof window === "undefined") return false;
  var brands = ((_window$navigator$use = ((_window2 = window) === null || _window2 === void 0 || (_window2 = _window2.navigator) === null || _window2 === void 0 ? void 0 : _window2.userAgent).userAgentData) === null || _window$navigator$use === void 0 ? void 0 : _window$navigator$use.brands) || [];
  return brands.some(function (b) {
    return /Chromium/i.test(b.brand);
  });
}

export { getBackgroundColor as a, getUnicodeLength as b, calculateNodeSize as c, getCharacterLength as d, getFlexGapPolyFill as e, getIEVersion as g, isSafari as i, limitUnicodeMaxLength as l, pxCompat as p };
//# sourceMappingURL=dep-9721fff3.js.map
