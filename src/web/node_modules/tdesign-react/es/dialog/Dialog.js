...
import { _ as _defineProperty } from '../_chunks/dep-5e72c8b9.js';
import { _ as _slicedToArray } from '../_chunks/dep-94a7af64.js';
import { _ as _objectWithoutProperties } from '../_chunks/dep-4461a684.js';
import React, { forwardRef, useRef, useState, useEffect, useImperativeHandle } from 'react';
import { CSSTransition } from 'react-transition-group';
import classNames from 'classnames';
import { isUndefined } from 'lodash-es';
import '../_chunks/dep-3561cd86.js';
import { p as pxCompat } from '../_chunks/dep-9721fff3.js';
import { c as canUseDocument } from '../_chunks/dep-a347b1b5.js';
...
import { l as log } from '../_chunks/dep-65d82dda.js';
...
var Dialog = /*#__PURE__*/forwardRef(function (originalProps, ref) {
  ...
  var _useState = useState(visible),
    ...
    animationVisible = _useState2[0],
    setAnimationVisible = _useState2[1];
  var _useState3 = useState(false),
    _useState4 = _slicedToArray(_useState3, 2),
    dialogAnimationVisible = _useState4[0],
    setDialogAnimationVisible = _useState4[1];
  var _useDialogEsc = useDialogEsc(visible, wrapRef),
    focusTopDialog = _useDialogEsc.focusTopDialog;
  useDialogLockStyle({
  ...
  useEffect(function () {
    if (dialogAnimationVisible) {
      ...
      (_wrapRef$current = wrapRef.current) === null || _wrapRef$current === void 0 || _wrapRef$current.focus();
      if (mousePosition && dialogCardRef.current) {
        var offsetX = mousePosition.x - dialogCardRef.current.offsetLeft;
        var offsetY = mousePosition.y - dialogCardRef.current.offsetTop;
        dialogCardRef.current.style.transformOrigin = "".concat(offsetX, "px ").concat(offsetY, "px");
      }
    }
  ...
  return /* @__PURE__ */React.createElement(CSSTransition, {
    ...
    style: {
      zIndex: zIndex,
      display: animationVisible ? void 0 : "none"
    },
