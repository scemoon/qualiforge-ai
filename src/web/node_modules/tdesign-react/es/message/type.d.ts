...
export type MessageMethod = (theme: MessageThemeList, message: string | TNode | MessageOptions, duration?: number) => Promise<MessageInstance>;
export type MessageInfoOptions = Omit<MessageOptions, 'theme'>;
export type MessageInfoMethod = (message: string | TNode | MessageInfoOptions, duration?: number) => Promise<MessageInstance>;
export type MessageErrorMethod = (message: string | TNode | MessageInfoOptions, duration?: number) => Promise<MessageInstance>;
export type MessageWarningMethod = (message: string | TNode | MessageInfoOptions, duration?: number) => Promise<MessageInstance>;
export type MessageSuccessMethod = (message: string | TNode | MessageInfoOptions, duration?: number) => Promise<MessageInstance>;
export type MessageLoadingMethod = (message: string | TNode | MessageInfoOptions, duration?: number) => Promise<MessageInstance>;
export type MessageQuestionMethod = (message: string | TNode | MessageInfoOptions, duration?: number) => Promise<MessageInstance>;
