...
| `article-crud` | 12 | articles, article_tags, tags, collections, notifications |
...
**公开前台**：10 个页面（/、/leaderboard、/article/search、/article/:id、/tags、/expert/:id、/login、/register）  
**专家中心**：5 个页面（/my/*）  
**管理后台**：11 个页面（/admin/*）
...
| Phase | 周期 | 交付内容 | 核心交付物 |
|-------|------|---------|-----------|
| **Phase 1** | Week 1–2 | 用户系统 + 基础文章 + 标签系统 | 登录注册、文章 CRUD、审核流程、标签筛选 |
...
**Phase 1 — 待启动**  
前置依赖：CloudBase 环境 envId（需要用户提供或创建）
